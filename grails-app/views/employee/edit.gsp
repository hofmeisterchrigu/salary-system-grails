...
<div class="row-fluid">
      ...
      <div class="span9">
            ...
            <fieldset>
                  <g:form class="form-horizontal" action="edit" id="${employeeInstance?.id}" >
                        <g:hiddenField name="id" value="${employeeInstance?.id}" />
                        <g:hiddenField name="version" value="${employeeInstance?.version}" />
                        <fieldset>
                              %{--<f:all bean="employeeInstance"/>--}%
...
<jqvalui:renderValidationScript for="com.deerwalk.dss.Employee" />
</body>
</html>
